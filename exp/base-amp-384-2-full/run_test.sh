...
torchrun --nproc_per_node="$N_GPUS" --master_port="$MASTER_PORT" ../../main.py \
    ...
    --output_dir '/home/kks/workspace/rock/exp/base-amp-384-2-full' \
    --log_dir '/home/kks/workspace/rock/exp/base-amp-384-2-full' \
    --resume '/home/kks/workspace/rock/exp/base-amp-384-2-full/checkpoint-49.pth' \
    --dist_eval False \
    --disable_eval True \
    --eval True \
    --num_workers 8 \
